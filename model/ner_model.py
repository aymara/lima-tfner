...
from .data_utils import minibatches, pad_sequences, get_chunks, create_test_file
...
class NERModel(BaseModel):
    ...
    def add_logits_op(self):
        ...
        with tf.variable_scope("proj"):
            ...
            self.logits = tf.reshape(pred, [-1, nsteps, self.config.ntags],name="output_node")
    ...
    def run_evaluate(self, test):
        ...
        print("--- Execution time total : %s seconds ---" % (time_t))
    ...
    def run_evaluate_on_cplusplus_api(self,test):
        ...
        Args:
            test: dataset tuple of (sentence, tag)
        ...
        accs = []
        correct_preds, total_correct, total_preds = 0., 0., 0.
        sequence_lengths, labels_pred,tag = [],[],[]
        ...
        for lab, lab_pred, length in zip(labels, labels_pred,
            ...
            lab      = lab[:length]
            lab_pred = lab_pred[:length]
            accs    += [a==int(b) for (a, b) in zip(lab, lab_pred)]
